...
if (sortSwitcher) {
    ...
    function bgs2BuildColorRadarSVG(clusters) {
        ...
        // putya: "тут три вершины только вместе с центром, хотя должно быть четыре, нижний цвет
        // на диаграме по многоугольнику не отражен" — прижимать самый лёгкий кластер к центру
        // нельзя: он теряет собственную вершину, и цвет пропадает из фигуры. Вершин ровно столько,
        // сколько цветов (у всех радиус по одной формуле, с полом RADAR_MIN_R_FRAC), а центр —
        // ДОПОЛНИТЕЛЬНАЯ вершина, когда он не вписывается в фигуру (см. ниже).
        ...
        // Центр лежит ВНУТРИ многоугольника ровно тогда, когда вершины окружают его со всех
        // сторон, то есть когда наибольший угловой разрыв между соседними вершинами меньше 180°.
        // Если все цвета сгрудились в одном секторе (а при двух цветах это всегда так), центр
        // остаётся снаружи и становится вершиной — обводка обходит его.
